...
module.exports.createAnimal = (req, res) => {
    Animal.create(req.body)
        ...
        .catch(err => res.json({message: "Something went wrong when creating an animal!", err: err}))
}
...
module.exports.findOneAnimal = (req, res) => {
    Animal.find({_id: req.params._id})
        ...
        .catch(err => res.json({message: "Something went wrong when finding one animal!", err: err}))
}
...
module.exports.findAllAnimals = (req, res) => {
    Animal.find()
        ...
        .catch(err => res.json({message: "Something went wrong when finding all animals!", err: err}))
}
...
module.exports.updateAnimal = (req, res) => {
    Animal.findOneAndUpdate({_id: req.params._id}, req.body)
        ...
        .catch(err => res.json({message: "Something went wrong when updating animal!", err: err}))
}
...
module.exports.deleteAnimal = (req, res) => {
    Animal.deleteOne({_id: req.params._id})
        ...
        .catch(err => res.json({message: "Something went wrong when deleting one animal!", err: err}))
}
